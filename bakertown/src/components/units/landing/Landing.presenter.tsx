        ...
        <S.CategoryWrapper>
          ...
          <S.CategoryButtonWrapper>
            <S.CategoryFirstWrapper>
              <S.CategoryButton value="베이킹">베이킹</S.CategoryButton>
              <S.CategoryButton value="마카롱">마카롱</S.CategoryButton>
              <S.CategoryButton value="케이크">케이크</S.CategoryButton>
            </S.CategoryFirstWrapper>
            <S.CategorySecondWrapper>
              <S.CategoryButton value="쿠키">쿠 키</S.CategoryButton>
              <S.CategoryButton value="커피">커 피</S.CategoryButton>
              <S.CategoryButton value="쇼콜라">쇼콜라</S.CategoryButton>
            </S.CategorySecondWrapper>
          </S.CategoryButtonWrapper>
        </S.CategoryWrapper>
      </S.Wrapper>
